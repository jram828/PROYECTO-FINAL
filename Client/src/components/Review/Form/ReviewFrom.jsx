      ...
      <>
        <div className="space-y-6 h-full p-6 bg-secondary rounded-lg shadow-md text-black flex-grow self-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="puntuacion" className="input input-md text-md !border-black !rounded-lg input-secondary flex items-center !text-black !w-full">
                Puntuación:
                <input
                  type="number"
                  name="puntuacion"
            ...
            <div className="flex flex-row items-center justify-center">
              <button type="submit" className="btn btn-xs border border-success bg-white hover:bg-white !w-36" disabled={user.matricula}>
                Enviar Reseña
              </button>
            </div>
          </form>
