  ...
  <div className="md:flex md:flex-col md:space-y-4">
    <div>
      <div className="flex justify-end p-4">
        <Link to="/home/customers/crearcliente" className="btn btn-md hover:bg-primary hover:text-white">Crear cliente</Link>
      </div>
    </div>
    <div className="flex flex-col gap-4 p-4 rounded-md max-h-screen bg-primary">
