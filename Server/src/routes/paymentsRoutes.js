...
const { getPaymentsHandler, failureHandler, pendingHandler, webhookHandler, statusHandler } = require("../handlers/paymentsHandler");
...
paymentsRouter.get("/status", statusHandler);
